...
<main class="content">
	<div class="container-fluid p-0">
		<h3 class="display-6"><span class=""></span>Exception</h3>
		<div class="d-md-flex justify-content-between">
			...
			<div class="btn-group">
				...
				<a class="btn" href="beban"><span data-feather="arrow-left"></span>Beban</a>
			</div>
			<form action="" method="get">
				<div class="input-group col-md-5 col-md-offset-7">
					...
					<select type="submit" name="thn" class="form-control" onchange="this.form.submit()">
						<option>.. Tahun ..</option>
						<?php 
						$pil=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct thn from exception order by thn desc");
	...
	<!-- View Table Data Exception -->
	<div class="card mt-3">
		<div class="card-header d-md-flex justify-content-between">
			<h5 class="card-title">	
			<?php 
			if(isset($_GET['thn'])){
				echo "Data Tahun ". $_GET['thn'];
			}else{
				echo "Data Pengurangan Beban";
			}
			?>
			</h5>
		</div>
		<div class="card-body">
			<table class="table table-hover">
				...
				if(isset($_GET['thn'])){
					...
					$brg=mysqli_query($GLOBALS["___mysqli_ston"], "select * from exception where thn = '$tah' order by no desc");
				}else{
					$jumlah_record=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * from exception");
					$per_hal=20;
					$jum=mysqli_num_rows($jumlah_record);
					$halaman=ceil($jum / $per_hal);
					$page = (isset($_GET['page'])) ? (int)$_GET['page'] : 1;
					$start = ($page - 1) * $per_hal;
					$brg=mysqli_query($GLOBALS["___mysqli_ston"], "select * from exception order by no limit $start, $per_hal");
				}
				$no=1;
				...
				?>
				<tr>
					<td><a href="exc_edit?no=<?php echo $b['no']; ?>"><?php echo $b['no'] ?></a></td>
			...
			<div class="d-flex justify-content-between">
				...
				<button type="submit" name="Export-exc" class="btn btn-success button-loading" data-loading-text="Loading..."><span class='glyphicon glyphicon-download'></span>  Export</button>
				...
				<div class="input-group">
					...
					<button type="submit" id="submit" name="Import-exc" class="btn btn-success button-loading" data-loading-text="Loading...">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="exc_act" method="post">
